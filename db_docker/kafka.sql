...
--
-- Host: localhost    Database: kafkadb
-- ------------------------------------------------------
...
--
-- Current Database: `kafkadb`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `kafkadb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `pomiary` (
  ...
  `average` float(20,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2021-06-05 20:54:11
